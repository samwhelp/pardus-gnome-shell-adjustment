...
``` sh
bash <(curl -L https://raw.githubusercontent.com/samwhelp/pardus-gnome-shell-adjustment/refs/heads/main/demo/scripts/alternative/by-filemanager-oriented/thunar/gnome-shell-keybind/gnome-shell-keybind.sh)
```

> or run

``` sh
bash <(wget -q https://raw.githubusercontent.com/samwhelp/pardus-gnome-shell-adjustment/refs/heads/main/demo/scripts/alternative/by-filemanager-oriented/thunar/gnome-shell-keybind/gnome-shell-keybind.sh -O - )
```
