...
mod_gnome_shell_config_for_favorite_apps () {
	...
	gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'org.gnome.TextEditor.desktop', 'firefox-esr.desktop', 'org.gnome.Console.desktop', 'org.gnome.Settings.desktop', 'org.gnome.tweaks.desktop', 'tr.org.pardus.pardus-gnome-greeter.desktop']"
